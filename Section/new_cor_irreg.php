...
?>
        ...
        <div class="main-page">
            ...
            sub.Subject_title,
            IF(
                sub.Subject_units = '0' OR sub.Subject_units IS NULL,
                '',
                sub.Subject_units
            ) AS Subject_units,
            IF(
                sub.Subject_lec = '0' OR sub.Subject_lec IS NULL,
                '',
                sub.Subject_lec
            ) AS Subject_lec,
            IF(
                sub.Subject_lab = '0' OR sub.Subject_lab IS NULL,
                '',
                sub.Subject_lab
            ) AS Subject_lab,
            ...
            IF(
                sub.complab IS NULL OR sub.complab = 0,
                '',
                sub.complab
            ) AS complabs,
            IF(
                sub.Subject_code LIKE '%nstp%',
                '3',
                ''
            ) AS nstp_units
        FROM
        ...
        LEFT JOIN `rooms` ro ON
            cs.Room_id = ro.Room_id
                ...
                <table border="1" style="border-collapse: collapse;width: 100%;font-size:13px;">
                    ...
                    <tbody>
                        ...
                        ?> <tr>
                                ...
                                <td><?php echo $r[6] ?></td>
                                <td style="text-align:center;height:25px;"><?php echo $r[7] ?></td>
                                <td style="text-align:center;height:25px;"><?php echo $r[8] ?></td>
